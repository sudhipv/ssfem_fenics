...
!!!*********************************************************
!!! Subroutine: To construc PETSc Matrix in most general way
SUBROUTINE StoMatSeqOneLevelShort(pid,Asii,Asgg,Asgi,np,nb,npcein,npceout,nip,nbp,ncijk,ijk,cijk,ierr)
...
#include <petsc/finclude/petscmat.h>
    ...
    if (pid .eq. 0) print*, 'PETSc-Mat Assembly: using FEniCS Assembly Mats'
...
#include <petsc/finclude/petscvec.h>
    ...
    if (pid .eq. 0) print*, 'PETSc-Vec Assembly: using FEniCS Assembly Vecs'
...
!!!*********************************************************
!!! Subroutine: To extract non-zero elements from PETSc Matrix Assembly
SUBROUTINE GetMallocsShort(pid,np,nb,npceout,nip,nbp,ierr)
...
#include <petsc/finclude/petscmat.h>
    ...
    if (pid .eq. 0) print*, 'PETSc-Mat Mallocs: using FEniCS Assembly Mats'
    if (pid .eq. 0) print*, 'PETSc-Vec Mallocs: using FEniCS Assembly Vecs'
