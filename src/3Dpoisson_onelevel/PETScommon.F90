...
SUBROUTINE StoVecSeqOneLevel(pid, Fsi, Fsg, np, nb, npceout, nip, nbp, ierr)
...
SUBROUTINE StoMatSeqOneLevel(pid,Asii,Asgg,Asgi,np,nb,npcein,npceout,nip,nbp,ncijk,ijk,cijk,ierr)
...
SUBROUTINE GetMallocs(pid,np,nb,npceout,nip,nbp,ierr)
