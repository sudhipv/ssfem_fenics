...
then
    ...
    cp fenics_activate_cedarcopy.sh ../fenics_activate.sh
else
...
sed -i -e 's#output=%j-3Dfenics.out#output=$SCRATCH/ssfem_fenics/data/slurm/3Dfenics-%j.out#g' run_fenics.sh
