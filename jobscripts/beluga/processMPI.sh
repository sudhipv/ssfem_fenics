...
sed -i -e 's/time=0-00:10/time=0-00:30/g' run_ddm.sh
...
sed -i -e 's/job-name=DP_nRV_nNodes_nParts/job-name=3DP_3RV_30KNodes_80Parts/g' run_ddm.sh
sed -i -e 's#output=%x-%j.out#output=/scratch/sudhipv/ssfem_fenics/data/slurm/%j-%x.out#g' run_ddm.sh
