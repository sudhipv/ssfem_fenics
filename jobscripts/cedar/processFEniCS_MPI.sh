...
sed -i -e 's/-n 32/-n 64/g' run_fenics.sh
sed -i -e 's#output=%j-3DPfenics.out#output=/scratch/sudhipv/sudhipv/ssfem_fenics/data/slurm/3Dfenics-%j.out#g' run_fenics.sh
