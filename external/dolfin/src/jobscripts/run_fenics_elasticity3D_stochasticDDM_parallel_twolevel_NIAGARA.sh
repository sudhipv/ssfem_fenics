...
#mpiexec -n 32 python -m mpi4py  gmshData_fenicsXML_parallel_3D.py


##############################################

# In order to remove the cache error for NIAGARA machine only
echo "TRIAL PROBLEM STARTS"
mpiexec -n 2 python -m mpi4py  gmshData_fenicsXML_parallel_3D.py
dijitso clean
